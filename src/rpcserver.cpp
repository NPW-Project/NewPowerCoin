...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* NPW features */
        {"npw", "masternode", &masternode, true, true, false},
        {"npw", "listmasternodes", &listmasternodes, true, true, false},
        {"npw", "getmasternodecount", &getmasternodecount, true, true, false},
        {"npw", "masternodeconnect", &masternodeconnect, true, true, false},
        {"npw", "masternodecurrent", &masternodecurrent, true, true, false},
        {"npw", "masternodedebug", &masternodedebug, true, true, false},
        {"npw", "startmasternode", &startmasternode, true, true, false},
        {"npw", "createmasternodekey", &createmasternodekey, true, true, false},
        {"npw", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"npw", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"npw", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"npw", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"npw", "getmasternodescores", &getmasternodescores, true, true, false},
        {"npw", "mnbudget", &mnbudget, true, true, false},
        {"npw", "preparebudget", &preparebudget, true, true, false},
        {"npw", "submitbudget", &submitbudget, true, true, false},
        {"npw", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"npw", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"npw", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"npw", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"npw", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"npw", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"npw", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"npw", "checkbudgets", &checkbudgets, true, true, false},
        {"npw", "mnsync", &mnsync, true, true, false},
        {"npw", "spork", &spork, true, true, false},
        {"npw", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"npw", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
{
    return "> npw-cli " + methodname + " " + args + "\n";
}
