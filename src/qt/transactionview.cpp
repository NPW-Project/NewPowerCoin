 ...
 */
    ...
    typeWidget->addItem(tr("Received NPW from zNPW"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zNPW"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zNpw));
