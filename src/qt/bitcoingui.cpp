...
const std::string VERSION_CHECK_SERVER = "www.npw.live";
                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("NPW Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a NPW address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and NPW: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zNPW"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About NPW Core"), this);
    aboutAction->setStatusTip(tr("Show information about NPW Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for NPW"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your NPW addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified NPW addresses"));
    ...
    openAction->setStatusTip(tr("Open a NPW: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the NPW Core help message to get a list with possible NPW command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("NPW Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to NPW network", "", count));
}
...
{
    QString strTitle = tr("NPW Core"); // default title
