Contributing to NPW Core
============================

The NPW Core project operates an open contributor model where anyone is
...
The following applies to code changes to the NPW Core project, and is not to be
confused with overall NPW Network Protocol consensus changes.

Whether a pull request is merged into NPW Core rests with the project merge
...
Patches that change NPW consensus rules are considerably more involved than
...
Where a patch set proposes to change the NPW consensus, it must have been
...
The project leader is the release manager for each NPW Core release.
