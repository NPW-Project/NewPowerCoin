...
RESOURCES += src/qt/npw.qrc src/qt/npw_locale.qrc

TRANSLATIONS += src/qt/locale/npw_bg.ts \
                src/qt/locale/npw_de.ts \
                src/qt/locale/npw_en.ts \
                src/qt/locale/npw_es.ts \
                src/qt/locale/npw_fi.ts \
                src/qt/locale/npw_fr.ts \
                src/qt/locale/npw_it.ts \
                src/qt/locale/npw_ja.ts \
                src/qt/locale/npw_pl.ts \
                src/qt/locale/npw_pt.ts \
                src/qt/locale/npw_ru.ts \
                src/qt/locale/npw_sk.ts \
                src/qt/locale/npw_sv.ts \
                src/qt/locale/npw_vi.ts \
                src/qt/locale/npw_zh_CN.ts \
                src/qt/locale/npw_zh_TW.ts
