...
#   c) node1 mines 32 blocks, so now node 0 has 60001npw, node 1 has 4250npw, node2 has none.
#   d) node0 sends 601 npw to node2, in two transactions (301 npw, then 300 npw).
