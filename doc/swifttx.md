...
This mechanism has been integrated into Bitcore-Node-NPW which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/NPW-Project/insight-api-npw#web-socket-api](https://github.com/NPW-Project/insight-api-npw#web-socket-api) 
* API: [https://github.com/NPW-Project/insight-api-npw#swifttx-transactions](https://github.com/NPW-Project/insight-api-npw#swifttx-transactions) 
...
By default, the NPW Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the NPW Core daemon:
