...
In order to support loading of multiple wallets in npw-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is npw.cpp.
...
Changes to npw.cpp
----------------------
npw.cpp is the entry point into npw-qt, and as such, will require some minor modifications to provide hooks for
