...
NPW Core version *version* is now available from:
...
NPW Core is extensively tested on multiple operating systems using
...
NPW Core should also work on most other Unix-like systems but is not
...
This allows running npwd without having to do any manual configuration.
